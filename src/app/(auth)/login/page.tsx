...
//   const { user, setAuthTokenAndUser } = useAuth(); // Destructure setAuthTokenAndUser
...
//       if (token) {
//         // Store token, email, and user ID in session storage
//         sessionStorage.setItem('authToken', token);
//         sessionStorage.setItem('userEmail', data.user.email); 
//         sessionStorage.setItem('userId', data.user.id); 

//         // Update AuthContext state
//         setAuthTokenAndUser(token, data.user);
//       }

//       router.push('/dashboard');
//       // No need to reload the page after login, AuthContext handles state update
//     } catch (err: unknown) {
