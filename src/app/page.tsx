...
export default function Home() {
  ...
  const [selectedTestimonialVideo, setSelectedTestimonialVideo] = useState<string | null>(null);
  ...
  const handleTestimonialClick = (videoKey: string) => {
    setSelectedTestimonialVideo(testimonialVideos[videoKey as keyof typeof testimonialVideos]);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-primary-black scroll-smooth">
      ...
      <VideoModal
        ...
        videoUrl={selectedTestimonialVideo || "https://www.youtube.com/embed/dQw4w9WgXcQ"} // Use selected video or default
      />

      {/* Value Proposition Section - Interactive */}
      <section id="value-proposition" className="py-20 bg-gradient-to-b from-primary-black to-neutral-gray-900 text-white relative overflow-hidden transition-all duration-1000">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-6xl font-extrabold leading-tight">
                <span className="text-primary-yellow">The innovative platform</span>
                <br />
            ...
            <div className="space-y-12">
              ...
              <div 
                ...
                onClick={() => {
                  document.getElementById('dominate-competition')?.scrollIntoView({ 
                    behavior: 'smooth', 
                    block: 'start' 
                  });
                }}
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-lg text-neutral-gray-300 leading-relaxed group-hover:text-white transition-colors duration-300">
                        So you can decrease your ad spend and convert more customers
                      </p>
              ...
              <div 
                className="group cursor-pointer transform transition-all duration-500 hover:scale-[1.02]"
                onClick={() => {
                  document.getElementById('dominate-competition-even-more')?.scrollIntoView({ 
                    behavior: 'smooth', 
                    block: 'start' 
                  });
                }}
                ...
                <div className="bg-gradient-to-r from-neutral-gray-800/50 to-neutral-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-neutral-gray-700/30 group-hover:border-primary-yellow/30 transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-primary-yellow/10">
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-4 flex items-center text-primary-yellow opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-[-10px] group-hover:translate-x-0">
                        <span className="text-sm font-medium">Discover insights</span>
                        <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                        </svg>
                      </div>
              ...
              <div 
                className="group cursor-pointer transform transition-all duration-500 hover:scale-[1.02]"
                onClick={() => {
                  document.getElementById('leave-competition-in-dust')?.scrollIntoView({ 
                    behavior: 'smooth', 
                    block: 'start' 
                  });
                }}
                ...
                <div className="bg-gradient-to-r from-neutral-gray-800/50 to-neutral-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-neutral-gray-700/30 group-hover:border-primary-yellow/30 transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-primary-yellow/10">
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-lg text-neutral-gray-300 leading-relaxed group-hover:text-white transition-colors duration-300">
                        So you can stop juggling Amazon&apos;s, eBay&apos;s, and other e-commerce dashboards and stay updated across everything
                      </p>
                      <div className="mt-4 flex items-center text-primary-yellow opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-[-10px] group-hover:translate-x-0">
                        <span className="text-sm font-medium">See unified dashboard</span>
                        <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                        </svg>
                      </div>
            ...
            <div className="text-center mt-16">
              ...
              <div className="mt-8">
                ...
                <p className="text-neutral-gray-400 text-sm mt-2">Early access! No credit card required</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="testimonials" className="py-20 bg-gradient-to-b from-neutral-gray-900 via-primary-black to-neutral-gray-900 text-white relative overflow-hidden">
        {/* Background decoration */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-primary-yellow/10 backdrop-blur-sm border border-primary-yellow/20 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-primary-yellow text-sm font-medium">REAL RESULTS</span>
              </div>
              <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
                See How Sellers Are <span className="text-primary-yellow">Winning</span> With Tezra
              </h2>
              <p className="text-lg md:text-xl text-neutral-gray-300 max-w-3xl mx-auto leading-relaxed">
                Real sellers, real results. Watch how Tezra transformed their e-commerce businesses from struggling to thriving.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              ...
              <div className="group cursor-pointer" onClick={() => handleTestimonialClick('sarah')}>
                  ...
                  <div className="relative aspect-video bg-gradient-to-br from-blue-900/30 to-purple-900/30 overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black/40 group-hover:bg-black/60 transition-colors duration-300">
                      <div className="w-16 h-16 bg-primary-yellow rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                        <svg className="w-6 h-6 text-primary-black ml-1" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="p-6">
                    <div className="flex items-start gap-3 mb-4">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-neutral-gray-400">Former Teacher → $12K/month</p>
                      </div>
                    ...
                    <blockquote className="text-neutral-gray-300 italic leading-relaxed text-sm mb-4">
                      "Tezra's predictions helped me find a viral product before anyone else. I went from $800/month to $12,000/month in 4 months."
                    </blockquote>
              ...
              <div className="group cursor-pointer" onClick={() => handleTestimonialClick('mike')}>
                <div className="bg-gradient-to-br from-neutral-gray-800/60 to-neutral-gray-900/60 backdrop-blur-sm rounded-2xl overflow-hidden border border-neutral-gray-700/30 hover:border-primary-yellow/30 transition-all duration-300 hover:shadow-2xl hover:shadow-primary-yellow/10 hover:scale-[1.02]">
                  ...
                  <div className="p-6">
                    <div className="flex items-start gap-3 mb-4">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-neutral-gray-400">College Student → $8K/month</p>
                      </div>
                      <div className="flex text-primary-yellow">
                        {[...Array(5)].map((_, i) => (
                          <svg key={i} className="w-4 h-4 fill-current" viewBox="0 0 20 20">
                    ...
                    <blockquote className="text-neutral-gray-300 italic leading-relaxed text-sm mb-4">
                      "The unified dashboard saved me 20+ hours a week. Now I can focus on scaling instead of managing spreadsheets."
                    </blockquote>
              ...
              <div className="group cursor-pointer md:col-span-2 lg:col-span-1" onClick={() => handleTestimonialClick('lisa')}>
                <div className="bg-gradient-to-br from-neutral-gray-800/60 to-neutral-gray-900/60 backdrop-blur-sm rounded-2xl overflow-hidden border border-neutral-gray-700/30 hover:border-primary-yellow/30 transition-all duration-300 hover:shadow-2xl hover:shadow-primary-yellow/10 hover:scale-[1.02]">
                  ...
                  <div className="p-6">
                    <div className="flex items-start gap-3 mb-4">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-neutral-gray-400">Retiree → $5K/month Passive</p>
                      </div>
                      <div className="flex text-primary-yellow">
                        {[...Array(5)].map((_, i) => (
                          <svg key={i} className="w-4 h-4 fill-current" viewBox="0 0 20 20">
                    ...
                    <blockquote className="text-neutral-gray-300 italic leading-relaxed text-sm mb-4">
                      "I started with crafts on Etsy. Tezra's optimization got me to page 1 on Amazon. Now it runs itself!"
                    </blockquote>
            ...
            <div className="bg-gradient-to-r from-neutral-gray-800/50 to-neutral-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-neutral-gray-700/30">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-primary-yellow mb-2">1</div>
                  <div className="text-sm text-neutral-gray-400">Successful Sellers</div>
                </div>
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-primary-yellow mb-2">100%</div>
                  <div className="text-sm text-neutral-gray-400">Avg Revenue Increase</div>
                </div>
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-primary-yellow mb-2">$2.5K</div>
                  <div className="text-sm text-neutral-gray-400">Additional Revenue Generated</div>
                </div>
                <div>
                  <div className="text-2xl md:text-3xl font-bold text-primary-yellow mb-2">1K+</div>
                  <div className="text-sm text-neutral-gray-400">Hours Saved Monthly</div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center mt-12">
              ...
              <p className="text-neutral-gray-400 text-sm mt-3">Start your transformation story now</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="dominate-competition" className="py-24 bg-primary-black text-white overflow-hidden transition-all duration-1000">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-8 text-center">
              ...
              <p className="text-xl md:text-2xl font-bold text-white max-w-4xl mx-auto leading-relaxed mb-8">
                ...
                <span className="text-primary-yellow">Optimization gets you sales.</span>
              </p>
              ...
              <div className="mt-8">
                ...
                <p className="text-neutral-gray-400 text-sm mt-3">Rank higher = sell more = more $$$</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="dominate-competition-even-more" className="py-24 bg-gradient-to-b from-primary-black via-neutral-gray-900 to-primary-black text-white relative overflow-hidden transition-all duration-1000">
        {/* Background decoration */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-lg md:text-xl max-w-4xl mx-auto font-light leading-relaxed text-neutral-gray-300">
                Tezra&apos;s market analysis engine knows what sells before it starts selling so you have a competitive edge. 
                <span className="block mt-2">Focus on your customers and we&apos;ll focus on the market.</span>
              </p>
            </div>
                ...
                <div className="bg-gradient-to-br from-neutral-gray-800/80 to-neutral-gray-900/80 backdrop-blur-sm rounded-2xl overflow-hidden border border-neutral-gray-700/50 hover:border-primary-yellow/30 transition-all duration-300 hover:shadow-2xl hover:shadow-primary-yellow/10 hover:scale-[1.02]">
                        ...
                        <div className="text-center text-gray-600">
                          <div className="w-12 h-12 bg-blue-500 rounded-lg mx-auto mb-1 flex items-center justify-center">
                            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2zM21 5a2 2 0 00-2-2h-4a2 2 0 00-2 2v12a4 4 0 004 4 4 4 0 004-4V5z" />
                            </svg>
                          </div>
                          <span className="text-xs font-medium">Wireless Earbuds</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="absolute bottom-3 left-3 right-3 z-20">
                      <div className="bg-black/80 backdrop-blur-sm rounded-lg p-2">
                        <div className="flex justify-between items-center mb-1">
                          <span className="text-xs text-green-400 font-medium">Predicted Growth</span>
                          <span className="text-primary-yellow text-sm font-bold">+284%</span>
                        </div>
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      <span className="bg-blue-500/20 text-blue-300 px-2 py-1 rounded-full text-xs font-medium">Electronics</span>
                      <span className="bg-green-500/20 text-green-300 px-2 py-1 rounded-full text-xs font-medium">High Demand</span>
                    </div>

                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-neutral-gray-400">Market Interest</span>
                        <span className="text-green-400 font-medium text-sm">↑ 340% this month</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-neutral-gray-400">Competition Level</span>
                        <span className="text-yellow-400 font-medium text-sm">Medium</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-neutral-gray-400">Profit Margin</span>
                        <span className="text-primary-yellow font-bold text-sm">68%</span>
                      </div>
                    </div>
                ...
                <div className="bg-gradient-to-br from-neutral-gray-800/80 to-neutral-gray-900/80 backdrop-blur-sm rounded-2xl overflow-hidden border border-neutral-gray-700/50 hover:border-primary-yellow/30 transition-all duration-300 hover:shadow-2xl hover:shadow-primary-yellow/10 hover:scale-[1.02]">
                  <div className="relative aspect-[5/3] overflow-hidden bg-gradient-to-br from-pink-500/20 to-rose-600/20">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-40 h-24 bg-gradient-to-br from-gray-200 to-gray-300 rounded-lg shadow-lg flex items-center justify-center">
                        <div className="text-center text-gray-600">
                          ...
                          <span className="text-xs font-medium">Smart Watch</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="absolute bottom-3 left-3 right-3 z-20">
                      <div className="bg-black/80 backdrop-blur-sm rounded-lg p-2">
                        <div className="flex justify-between items-center mb-1">
                          <span className="text-xs text-green-400 font-medium">Social Buzz</span>
                          <span className="text-primary-yellow text-sm font-bold">+412%</span>
                        </div>
                        <div className="w-full bg-gray-700 rounded-full h-1.5">
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      <span className="bg-pink-500/20 text-pink-300 px-2 py-1 rounded-full text-xs font-medium">Wearables</span>
                      <span className="bg-purple-500/20 text-purple-300 px-2 py-1 rounded-full text-xs font-medium">Viral</span>
                    </div>

                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-neutral-gray-400">Market Interest</span>
                        <span className="text-green-400 font-medium text-sm">↑ 412% this month</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-neutral-gray-400">Competition Level</span>
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-neutral-gray-400">Profit Margin</span>
                        <span className="text-primary-yellow font-bold text-sm">45%</span>
                      </div>
                    </div>
            ...
            <div className="text-center">
              <p className="text-xl md:text-2xl text-white max-w-4xl mx-auto leading-relaxed mb-4">
                Winning isn&apos;t about luck; it&apos;s about spotting signals first. Tezra runs 24/7 to find what&apos;s next before the rest.
              </p>
              ...
              <div className="mt-8">
                ...
                <p className="text-neutral-gray-400 text-sm mt-3">Get early access to market predictions</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="leave-competition-in-dust" className="py-20 bg-gradient-to-b from-primary-black via-neutral-gray-900 to-primary-black text-white relative overflow-hidden transition-all duration-1000">
        {/* Background decoration */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-lg md:text-xl max-w-4xl mx-auto font-light leading-relaxed text-neutral-gray-300">
                Tezra allows you to easily manage orders and inventory across multiple e-commerce channels so you can automate and streamline processes. 
                <span className="block mt-2">Get insightful analytics across channels so you can make smarter decisions.</span>
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-neutral-gray-800/80 to-neutral-gray-900/80 backdrop-blur-sm rounded-2xl border border-neutral-gray-700/50 p-4 md:p-6 shadow-2xl">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
                <div className="bg-gradient-to-br from-neutral-gray-700/50 to-neutral-gray-800/50 rounded-lg p-3 border border-neutral-gray-600/30">
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-xs font-medium text-neutral-gray-400 uppercase tracking-wide">Revenue</span>
                    <svg className="w-3 h-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                    </svg>
                  </div>
                  <div className="text-lg md:text-xl font-bold text-white mb-0.5">$24,847</div>
                  <div className="text-xs text-green-400 font-medium">↑ 12.3%</div>
                </div>

                <div className="bg-gradient-to-br from-neutral-gray-700/50 to-neutral-gray-800/50 rounded-lg p-3 border border-neutral-gray-600/30">
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-xs font-medium text-neutral-gray-400 uppercase tracking-wide">Orders</span>
                    <svg className="w-3 h-3 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                    </svg>
                  </div>
                  <div className="text-lg md:text-xl font-bold text-white mb-0.5">1,247</div>
                  <div className="text-xs text-green-400 font-medium">↑ 8.1%</div>
                </div>

                <div className="bg-gradient-to-br from-neutral-gray-700/50 to-neutral-gray-800/50 rounded-lg p-3 border border-neutral-gray-600/30">
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-xs font-medium text-neutral-gray-400 uppercase tracking-wide">Margin</span>
                  ...
                  <div className="text-lg md:text-xl font-bold text-white mb-0.5">34.2%</div>
                  <div className="text-xs text-green-400 font-medium">↑ 2.1%</div>
                </div>

                <div className="bg-gradient-to-br from-neutral-gray-700/50 to-neutral-gray-800/50 rounded-lg p-3 border border-neutral-gray-600/30">
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-xs font-medium text-neutral-gray-400 uppercase tracking-wide">Stock</span>
                    <svg className="w-3 h-3 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                    </svg>
                  </div>
                  <div className="text-lg md:text-xl font-bold text-white mb-0.5">847</div>
                  <div className="text-xs text-yellow-400 font-medium">23 alerts</div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6 mb-6">
                ...
                <div className="bg-gradient-to-br from-neutral-gray-700/30 to-neutral-gray-800/30 rounded-lg p-4 border border-neutral-gray-600/20">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="text-base font-semibold text-white">Revenue Trends</h4>
                    <div className="flex items-center gap-1.5">
                      <div className="w-1.5 h-1.5 bg-primary-yellow rounded-full"></div>
                      <span className="text-xs text-neutral-gray-400">30 days</span>
                    </div>
                  </div>
                ...
                <div className="bg-gradient-to-br from-neutral-gray-700/30 to-neutral-gray-800/30 rounded-lg p-4 border border-neutral-gray-600/20">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="text-base font-semibold text-white">Platform Split</h4>
                    <span className="text-xs text-neutral-gray-400">This month</span>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-white font-medium w-8">60%</span>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                        <span className="text-sm text-white font-medium">eBay</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-16 h-1.5 bg-neutral-gray-700 rounded-full overflow-hidden">
                          <div className="w-[25%] h-full bg-green-500 rounded-full"></div>
                        </div>
                        <span className="text-sm text-white font-medium w-8">25%</span>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                        <span className="text-sm text-white font-medium">Etsy</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-16 h-1.5 bg-neutral-gray-700 rounded-full overflow-hidden">
                          <div className="w-[15%] h-full bg-orange-500 rounded-full"></div>
                        </div>
                        <span className="text-sm text-white font-medium w-8">15%</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-br from-neutral-gray-700/30 to-neutral-gray-800/30 rounded-lg p-4 border border-neutral-gray-600/20">
                <h4 className="text-base font-semibold text-white mb-3">Live Activity</h4>
                <div className="space-y-2 max-h-28 overflow-y-auto">
                  <div className="flex items-center gap-2.5 p-2.5 bg-neutral-gray-800/50 rounded-lg">
                    <div className="w-1.5 h-1.5 bg-green-500 rounded-full animate-pulse"></div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-sm text-white font-medium">New order #1247</span>
                        <span className="text-xs bg-blue-500/20 text-blue-300 px-1.5 py-0.5 rounded">Amazon</span>
                      </div>
                      <p className="text-xs text-neutral-gray-400 truncate">Premium Wireless Earbuds - $89.99</p>
                    </div>
                  ...
                  <div className="flex items-center gap-2.5 p-2.5 bg-neutral-gray-800/50 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-sm text-white font-medium">Low stock alert</span>
                        <span className="text-xs bg-green-500/20 text-green-300 px-1.5 py-0.5 rounded">eBay</span>
                      </div>
                      <p className="text-xs text-neutral-gray-400 truncate">Fitness Tracker - Only 5 left</p>
                    </div>
                  ...
                  <div className="flex items-center gap-2.5 p-2.5 bg-neutral-gray-800/50 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-sm text-white font-medium">Price optimized</span>
                        <span className="text-xs bg-orange-500/20 text-orange-300 px-1.5 py-0.5 rounded">Etsy</span>
                      </div>
                      <p className="text-xs text-neutral-gray-400 truncate">Smart Watch → $124.99</p>
                    </div>
            ...
            <div className="text-center mt-12">
              <p className="text-lg md:text-xl font-medium text-white max-w-3xl mx-auto leading-relaxed mb-3">
                Stay ahead of orders, inventory, and your competition – all in one live dashboard.
              </p>
              ...
              <div className="mt-8">
                ...
                <p className="text-neutral-gray-400 text-sm mt-3">Connect all your platforms in minutes</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-black via-neutral-gray-900 to-primary-black text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
              Ready to <span className="text-primary-yellow">dominate</span> your competition?
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-neutral-gray-400">
              <div className="flex items-center">
                <svg className="w-4 h-4 mr-2 text-primary-yellow" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-neutral-gray-400 text-lg max-w-md mx-auto leading-relaxed">
                The AI-powered platform that automates and grows your e-commerce business
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 mb-12">
              ...
              <div className="bg-neutral-gray-800/50 backdrop-blur-sm rounded-full px-6 py-3 border border-neutral-gray-700/30 hover:border-primary-yellow/30 transition-all duration-300 group">
                <div className="flex items-center gap-4">
                  <Link href="#features" className="text-neutral-gray-300 hover:text-primary-yellow transition-colors text-sm font-medium">
                    Features
                  </Link>
                  <div className="w-px h-4 bg-neutral-gray-600"></div>
                  <Link href="/pricing" className="text-neutral-gray-300 hover:text-primary-yellow transition-colors text-sm font-medium">
                    Pricing
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-neutral-gray-800/50 backdrop-blur-sm rounded-full px-6 py-3 border border-neutral-gray-700/30 hover:border-primary-yellow/30 transition-all duration-300 group">
                <div className="flex items-center gap-4">
                  <Link href="/about" className="text-neutral-gray-300 hover:text-primary-yellow transition-colors text-sm font-medium">
                    About
                  </Link>
                  <div className="w-px h-4 bg-neutral-gray-600"></div>
                  <Link href="/contact" className="text-neutral-gray-300 hover:text-primary-yellow transition-colors text-sm font-medium">
                    Contact
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-neutral-gray-800/50 backdrop-blur-sm rounded-full px-6 py-3 border border-neutral-gray-700/30 hover:border-primary-yellow/30 transition-all duration-300 group">
                <div className="flex items-center gap-4">
                  <Link href="/terms" className="text-neutral-gray-300 hover:text-primary-yellow transition-colors text-sm font-medium">
                    Terms
                  </Link>
                  <div className="w-px h-4 bg-neutral-gray-600"></div>
                  <Link href="/privacy" className="text-neutral-gray-300 hover:text-primary-yellow transition-colors text-sm font-medium">
                    Privacy
                  </Link>
                </div>
              </div>
            ...
            <div className="text-center mb-12">
              <h4 className="text-xl font-bold text-white mb-4">Ready to sell more and work less?</h4>
              <div className="relative group inline-block">
                <div className="absolute -inset-1 bg-gradient-to-r from-yellow-300 via-primary-yellow to-amber-500 rounded-full opacity-70 group-hover:opacity-100 blur group-hover:blur-md transition-all duration-500"></div>
                <a 
                  href="https://tally.so/r/m69ErJ" 
            ...
            <div className="flex items-center justify-center gap-6 mb-12">
              <div className="text-center">
                <p className="text-neutral-gray-500 text-sm mb-3">Will support all major platforms</p>
                <div className="flex items-center gap-4">
                  <div className="flex items-center justify-center h-8 group cursor-pointer">
                    <Image
                      src="/assets/Amazon-Logo-500x281.png"
