...
const navVariants: Variants = {
  ...
  visible: {
    ...
    opacity: 1,
    transition: {
      type: "spring" as const, // 👈 Ensure it's not just a generic string
      stiffness: 300,
      damping: 30,
      mass: 0.8,
    },
...
const dropdownVariants: Variants = {
  ...
  visible: {
    ...
    scale: 1,
    transition: {
      type: "spring" as const,  // ✅ Ensures correct literal type
      stiffness: 400,
      damping: 25,
      mass: 0.5,
    },
  ...
  exit: {
    ...
    transition: {
      duration: 0.15,
      ease: "easeInOut" as const, // ✅ Framer Motion expects a specific literal here too
    },
  },
};
const itemVariants: Variants = {
  ...
  visible: (i: number) => ({
    ...
    transition: {
      delay: i * 0.03,
      type: "spring" as const, // ✅ Ensure correct type
      stiffness: 500,
      damping: 25,
    },
  }),
...
const buttonVariants: Variants = {
  ...
  hover: {
    scale: 1.05,
    transition: {
      type: "spring" as const, // ✅ fixes TS type issue
      stiffness: 400,
      damping: 25,
    },
  },
